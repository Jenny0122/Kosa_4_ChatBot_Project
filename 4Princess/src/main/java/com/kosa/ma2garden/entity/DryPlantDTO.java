...
public class DryPlantDTO {
	...
	public DryPlantDTO(long no, String plant_name, String chartr_info, String flwr_info, String light_info, String grwt_info, String water_cycle_info, String batch_place_info) {
		super();
		this.no = no;
