...
public class DryPlant {
	...
	public String toString() {
		return "DryPlant [no=" + no + ", plant_name=" + plant_name + ", chartr_info=" + chartr_info + ", flwr_info=" + flwr_info + ", grwt_info=" + grwt_info + ", water_cycle_info=" + water_cycle_info +", batch_place_info=" + batch_place_info + "]";
	}
