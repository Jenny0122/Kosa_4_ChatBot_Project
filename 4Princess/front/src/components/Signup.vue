    ...
    <section class="wrapper alt style2">
      <div class="inner">
        <div class="inner2">
          <br />
          <h2>{{ msg }}</h2>
          <form class="inner2form" novalidate="true">
            <h3>
                아이디
                <h4 v-if="!idValid && user.id!=''">영문, 숫자를 사용하세요.</h4>
                <h4 v-if="checkFlag && !user.id">아이디를 입력해주세요.</h4>
                <h4 v-if="checkSignupFlag">중복되는 아이디가 있습니다. 아이디를 변경해주세요</h4>
            </h3>
            <b-input
                type="text"
                v-model="user.id"
            ...
            <h3>
                이메일
                <h4 v-if="!emailFlag && user.email!=''">유효하지 않은 이메일 주소 입니다.</h4>
                <h4 v-if="checkFlag && !user.email">이메일을 입력해주세요.</h4>
            </h3>
            <b-input
              type="email"
              v-model="user.email"
            ...
            <h3>
                비밀번호
                <h4 v-if="!passwordValidFlag && user.password!=''">8~16자 영문 대 소문자, 숫자를 사용하세요.</h4>
                <h4 v-if="checkFlag && !user.password">비밀번호를 입력해주세요.</h4>
            </h3>
            <b-input
              type="password"
            ...
            <h3>
                비밀번호 재확인
                <h4 v-if="!passwordCheckFlag && password_conf!=''">비밀번호 일치하지 않습니다.</h4>
                <h4 v-if="checkFlag && !password_conf">비밀번호를 입력해주세요.</h4>
            </h3>
            <b-input
              type="password"
            ...
            />
            <br />
            <b-button @click="createUser">회원가입</b-button>
          </form>
        </div>
      </div>
    </section>
...
export default {
  ...
  data() {
    return {
      ...
      checkSignupFlag: false
    }
  },
  computed: {
    idValid() { return /^[A-Za-z0-9]+$/.test(this.user.id) } // id 유효성 체크
  },
  methods: {
    emailValid() {
        var regex = /([\w-.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$/
        if (this.user.email !== '' && this.user.email !== 'undefined' && regex.test(this.user.email)) {
            this.emailFlag = true
        } else {
    ...
    passwordCheckValid() { // password_conf 유효성 체크
        if (this.user.password === this.password_conf) {
...
.button {
  ...
  box-shadow: inset 0 0 0 2px #21b2a6;
  color: #fff;
  cursor: pointer;
  display: inline-block;
  font-size: 0.9em;
...
button:hover,
.button:hover {
  background-color: rgb(24, 197, 250);
  box-shadow: inset 0 0 0 2px rgb(24, 197, 250);
}
